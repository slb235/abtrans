...
class LanguagesControllerTest < ActionController::TestCase
  ...
  test "should create language" do
    assert_difference('Language.count') do
      post :create, language: { locale: @language.locale, project_id: @language.project_id, title: @language.title }
    end
  ...
  test "should update language" do
    patch :update, id: @language, language: { locale: @language.locale, project_id: @language.project_id, title: @language.title }
    assert_redirected_to language_path(assigns(:language))
  end
